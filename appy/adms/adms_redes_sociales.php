...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------// 
        ...
        $table = "tbla_rdsc";
        $captcha ="off";
        $config['datatable_title'] = "Redes Sociales";
        $config['datatable_actions_path'] = $path."app/";
        $title = "Gesti&oacute;n de Datos";
        // Datos del formulario
        $form =  array(
            array ('campo' => 'rdsc_nomb', 'nombre' => 'Nombre de la red social', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'), 
            array ('campo' => 'rdsc_user', 'nombre' => 'Nombre de usuario', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'), 
            array ('campo' => 'rdsc_durl', 'nombre' => 'Direcci&oacute;n URL', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'),
            array ('campo' => 'rdsc_clas', 'nombre' => 'Clase CSS ', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'),
            array ('campo' => 'rdsc_estd', 'nombre' => 'Estado del registro', 'tipo_objeto' => 'input_radio', 'tipo_dato' => 'bool', 'opcion0' => 'Inactivo', 'opcion1' => 'Activo'), 
        );
...
//========================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================// 
            ...
            case "listar":
                if ($permisos['cons'] == TRUE){
                    ...
                    $id_tabla = FALSE;
                    $sql = "SELECT * FROM tbla_rdsc ORDER BY id DESC";
                    $legend = $page_title;
                    $dt_acciones = array('editar' => '', 'eliminar' => '', 'auditoria' => '');
                    $datatable = array(
                        array('nombre' => 'Nombre de la red social', 'width' => '', 'campo' => 'rdsc_nomb', 'formato' => 'normal'), 
                        array('nombre' => 'Nombre de usuario', 'width' => '', 'campo' => 'rdsc_user', 'formato' => 'normal'), 
                        array('nombre' => 'Direcci&oacute;n URL', 'width' => '', 'campo' => 'rdsc_durl', 'formato' => 'normal'), 
                        array('nombre' => 'Estado', 'width' => '', 'campo' => 'rdsc_estd', 'formato' => 'radio', 'opcion0' => 'Inactivo', 'opcion1' => 'Activo'), 
                        array('nombre' => 'Fecha de ingreso', 'width' => '', 'campo' => 'rdsc_freg', 'formato' => 'datetime'), 
                    );
