...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------// 
    ...
    $page_title = "L&iacute;nea de los Productos";
    $meta = "";
    $css = "";
    $js = "";
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------// 
        ...
        $table = "tbla_prln";
        $captcha ="off";
        $config['datatable_title'] = "L&iacute;nea de los productos";
        $config['datatable_actions_path'] = $path."app/";
        $title = "Gesti&oacute;n de Datos";
        // Datos del formulario
        $form =  array(
            array ('campo' => 'prln_prct', 'nombre' => 'Categor&iacute;a', 'tipo_objeto' => 'select', 'tipo_dato' => 'integer', 'tabla' => 'tbla_prct', 'orden' => 'prct_nomb', 'valor' => 'id', 'descripcion' => 'prct_nomb'),             
            array ('campo' => 'prln_nomb', 'nombre' => 'Nombre', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'), 
            array ('campo' => 'prln_estd', 'nombre' => 'Estado', 'tipo_objeto' => 'input_radio', 'tipo_dato' => 'bool', 'opcion0' => 'Inactivo', 'opcion1' => 'Activo'), 
        );
...
//========================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================// 
            ...
            case "listar":
                if ($permisos['cons'] == TRUE){
                    $id_tabla = FALSE;
                    $sql = "SELECT tbla_prln.id, prln_nomb, prln_estd, prln_freg, "
                    ...
                    $datatable = array(
                        array('nombre' => 'Categor&iacute;a', 'width' => '', 'campo' => 'prct_nomb', 'formato' => 'normal'), 
                        array('nombre' => 'Nombre', 'width' => '', 'campo' => 'prln_nomb', 'formato' => 'normal'), 
                        array('nombre' => 'Estado', 'width' => '', 'campo' => 'prln_estd', 'formato' => 'radio', 'opcion0' => 'Inactivo', 'opcion1' => 'Activo'), 
                        array('nombre' => 'Fecha de ingreso del registro', 'width' => '', 'campo' => 'prln_freg', 'formato' => 'datetime'), 
                    );
