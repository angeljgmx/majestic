...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        $sche = "";
        $tabla = "tbla_adms";
        $campos = "id, adms_nomb, adms_apll, adms_sexo, adms_mail";
        ...
        if ($rs_existe_registro == 1){           
            ...
            $_SESSION['sson_mail'] =  $rs_datos->adms_mail;             // email de la persona
    ...
    echo "<form id=\"form_login\" name=\"form_login\" class=\"lock-form lock-form-custom\" action=\"".$action."\" method=\"post\"> \n"
        ...
        ."<input id=\"adms_mail\" name=\"adms_mail\" class=\"form-control placeholder-no-fix form-control-custom\" type=\"email\" autocomplete=\"off\" placeholder=\"Direcci&oacute;n Email\"  />  \n"
        ."</div> \n"
        ."<div class=\"form-group\"> \n"
        ."<input id=\"adms_pass\" name=\"adms_pass\" class=\"form-control placeholder-no-fix form-control-custom\" type=\"password\" autocomplete=\"off\" placeholder=\"Contrase&ntilde;a\" name=\"password\" />  \n"
        ."</div> \n"
