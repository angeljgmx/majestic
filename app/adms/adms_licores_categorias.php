...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------// 
    ...
    $page_title = "Licores - Categor&iacute;as";
    $meta = "";
    $css = "";
    $js = "";
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------// 
        ...
        $table = "tbla_lcct";
        $captcha ="off";
        $config['datatable_title'] = "Licores - Categor&iacute;as";
        $config['datatable_actions_path'] = $path."app/";
        $title = "Gesti&oacute;n de Datos";
        // Datos del formulario
        $form =  array(
            array ('campo' => 'lcct_nomb', 'nombre' => 'Nombre', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'),
            array ('campo' => 'lcct_estd', 'nombre' => 'Estado del registro', 'tipo_objeto' => 'input_radio', 'tipo_dato' => 'bool', 'opcion0' => 'Inactivo', 'opcion1' => 'Activo'), 
        );
...
//========================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================// 
            ...
            case "listar":
                if ($permisos['cons'] == TRUE){
                    $id_tabla = FALSE;
                    $sql = "SELECT * FROM tbla_lcct ORDER BY id ASC";
                    $legend = $page_title;
                    $dt_acciones = array('editar' => '', 'eliminar' => '', 'auditoria' => '');
                    $datatable = array(
                        array('nombre' => 'Categor&iacute;a del Licor', 'width' => '', 'campo' => 'lcct_tipo', 'formato' => 'normal'), 
                        array('nombre' => 'Estado del registro', 'width' => '', 'campo' => 'lcct_estd', 'formato' => 'radio', 'opcion0' => 'Inactivo', 'opcion1' => 'Activo'), 
                        array('nombre' => 'Fecha de ingreso del registro', 'width' => '', 'campo' => 'lcct_freg', 'formato' => 'datetime'), 
                    );
