...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------// 
        ...
        $table = "tbla_lcmc";
        $captcha ="off";
        $config['datatable_title'] = "Licores - Tipos";
        $config['datatable_actions_path'] = $path."app/";
        $title = "Gesti&oacute;n de Datos";
        // Datos del formulario
        $form =  array(
            array ('campo' => 'lcmc_tipo', 'nombre' => 'Tipo de Directiva', 'tipo_objeto' => 'input_text', 'tipo_dato' => 'cleartext'),
...
//========================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================// 
            ...
            case "listar":
                if ($permisos['cons'] == TRUE){
                    ...
                    $datatable = array(
                        array('nombre' => 'Tipo de Licor', 'width' => '', 'campo' => 'lcmc_tipo', 'formato' => 'normal'), 
