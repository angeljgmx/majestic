 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
   ...
   $_pagi_result2 = mysqli_query($conec->itl_dbConexion(), $_pagi_sqlConta);
   ...
   $_pagi_result3 = mysqli_query($conec->itl_dbConexion(), $_pagi_sql);
   // Si ocurrio error y mostrar errores esta activado
 ...
 */
 ...
 if ($_pagi_actual != 1){
   ...
   $_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_anterior." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'><span class=\"btn_prev\">$_pagi_nav_anterior</span></a></li>";
	 }
 ...
 if ($_pagi_actual < $_pagi_totalPags){
    ...
    $_pagi_url = $_pagi_actual + 1; //sera el numero de pagina al que enlazamos
    $_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_siguiente." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'><span class=\"btn_next\">$_pagi_nav_siguiente</span></a></li>";
...
//  $_pagi_sqlLim = $_pagi_sql." LIMIT $_pagi_inicial,$_pagi_cuantos";
 ...
 $_pagi_result = mysqli_query($conec->itl_dbConexion(), $_pagi_sqlLim);
 // Si ocurrio error y mostrar errores esta activado
